...
😈 在回过头看 [「2.1.4 示例」](https://svip.iocoder.cn/Spring/IoC-load-Resource/#) ，如果将 DefaultResourceLoader 改为 FileSystemResourceLoader ，则 `fileResource1` 则为 FileSystemResource 类型的资源。
...
![](http://static.iocoder.cn/bbb679d9d2be10643fd7e20ca88d3f2b)
